...
import com.ttd.sdk.utils.adapter.CommonAdapter;

import java.util.List;


public abstract class SectionedBaseAdapter<T> extends CommonAdapter<T> implements PinnedHeaderListView.PinnedSectionedHeaderAdapter {
    ...
    public SectionedBaseAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        return getItemView(getSectionForPosition(position), getPositionInSectionForPosition(position), viewHolder.getConvertView(), parent);
    }
...
//    @Override
//    public void onHeaderChange(int firstVisibleItem) {
