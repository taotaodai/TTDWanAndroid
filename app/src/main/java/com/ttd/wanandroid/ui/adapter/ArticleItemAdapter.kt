 ...
 */
class ArticleItemAdapter : BaseCompatAdapter<ArticleBean.ArticleData.Article, BaseViewHolder> {

    constructor(layoutResId: Int, data: MutableList<ArticleBean.ArticleData.Article>?) : super(layoutResId, data)

    constructor(layoutResId: Int) : super(layoutResId)

    override fun convert(helper: BaseViewHolder?, item: ArticleBean.ArticleData.Article?) {
